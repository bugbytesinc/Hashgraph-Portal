...
public partial class ContinueToken : ComponentBase
{
    [Inject] public DefaultsService DefaultsService { get; set; } = default!;

    private Network _network = default!;
    private ContinueTokenInput _input = new ContinueTokenInput();
    ...
    protected async Task HandleValidSubmit()
    {
        ...
        {
            _output = await client.ContinueTokenAsync(_input.Token!, ctx => ctx.Memo = _input.Memo?.Trim());
        });
    }
...
public class ContinueTokenInput
{
