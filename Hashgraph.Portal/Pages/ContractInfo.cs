...
{
    public partial class ContractInfo : ComponentBase
    {
        [Inject] public DefaultsService DefaultsService { get; set; }

        private Network _network = null;
        private ContractInfoInput _input = new ContractInfoInput();
        private Hashgraph.ContractInfo _output = null;
        ...
        protected async Task HandleValidSubmit()
        {
            ...
            {
                _output = await client.GetContractInfoAsync(_input.Contract, ctx => ctx.Memo = _input.Memo?.Trim());
            });
        }
    }
    public class ContractInfoInput
    {
        ...
        [Required(ErrorMessage = "Please enter the Contract you wish to query.")]
