...
public partial class PauseToken : ComponentBase
{
    [Inject] public DefaultsService DefaultsService { get; set; } = default!;

    private Network _network = default!;
    private PauseTokenInput _input = new PauseTokenInput();
    ...
    protected async Task HandleValidSubmit()
    {
        ...
        {
            _output = await client.PauseTokenAsync(_input.Token!, ctx => ctx.Memo = _input.Memo?.Trim());
        });
    }
