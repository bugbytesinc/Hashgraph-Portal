...
{
    public partial class AssociateToken : ComponentBase
    {
        [Inject] public DefaultsService DefaultsService { get; set; }

        private Network _network = null;
        private AssociateTokenInput _input = new AssociateTokenInput();
        ...
        protected async Task HandleValidSubmit()
        {
            ...
            {
                _output = await client.AssociateTokenAsync(_input.Token, _input.Account, ctx => ctx.Memo = _input.Memo?.Trim());
            });
        }
    }
    public class AssociateTokenInput
    {
